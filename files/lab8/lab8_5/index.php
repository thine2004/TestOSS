...
// --- ĐÃ SỬA: KHỞI TẠO CÁC ĐỐI TƯỢNG MODEL CHUYÊN DỤNG ---
// Các đối tượng này sẽ được sử dụng trong các module tương ứng.
$bookModel = new Book();
$newsModel = new News(); // SỬ DỤNG CLASS NEWS ĐÃ ĐƯỢC TẠO
// --------------------------------------------------------
?>
...
<table width="90%" border="1" align="center">
    ...
    <tr>
        ...
        <td width="29%" valign="top">
            <?php
            // --- ĐÃ SỬA: Thay thế truy vấn trực tiếp bằng việc gọi phương thức của Model ---
            // Lấy 10 tin tức nổi bật từ Model
            $news = $newsModel->getHotNews(10); 
